      ...
      },
      {
        ...
        use(g) {
          if (g.flag('act4')) {
            ...
            if (g.flag('barricaded')) g.remark('The sofa stays where it is.');
            else if (g.flag('choice_open') && !g.flag('chose_search')) {
              // teach the barricade at the door itself
              g.remark('Can’t outrun him to the car on foot. But the sofa — I could shove it against this door.');
            } else g.remark('Not out there. Not now.');
